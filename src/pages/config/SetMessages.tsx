            ...
            <section>
                ...
                <CustomSelect>
                    <Switch
                        ...
                        onColor="#3B82F6"
                        handleToggle={() => setWelcomeMessageEnablity(!welcomeMessageEnablity)}
                        id="welcome_message_switch"
                    />
                </CustomSelect>
            </section>
            {/* If enabled, show the following: */}
            {welcomeMessageEnablity && <section>
                <div>
            ...
            <section>
                ...
                <CustomSelect>
                    <Switch
                        ...
                        onColor="#3B82F6"
                        handleToggle={() => setLeaveMessageEnablity(!leaveMessageEnablity)}
                        id="leave_message_switch"
                    />
                </CustomSelect>
            </section>
            {/* If enabled, show the following: */}
            {leaveMessageEnablity && <section>
                <div>
                    <label>Current Channel:</label>
                </div>
                <CustomSelect>
